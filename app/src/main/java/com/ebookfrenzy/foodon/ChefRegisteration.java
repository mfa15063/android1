...
//    String[] Rajkot={"Kalawad Road","Astron chowk","Kotecha chowk","Trikon bag"};
    ...
    String firstName, lastName, email, phone, password, confirmPassword, state, city, town, localAddress, postCode, role = "Chef";
    Button signup;
    TextView signin;
    FirebaseAuth FAuth;
        ...
        try {
            ...
            signin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(ChefRegisteration.this, ChefLogin.class));
                    finish();
